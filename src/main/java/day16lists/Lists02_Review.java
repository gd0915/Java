...
public class Lists02_Review {
    ...
    public static void main(String[] args) {
        ...
        c.remove(3);
        System.out.println(c);//[Shoes, TV, Radio, Shoes, Book, Shoes]
        ...
        System.out.println(e);//[12, 13, 25, 432]
        ...
        if(isExist){
            ...
            System.out.println("Does not exist");     //The element exists
        }
        ...
        if(m.equals(n)){
            System.out.println("The Lists are same");//The Lists are same
        }else{
        ...
        if(p.containsAll(q)){
            System.out.println("The elements exist");
        }else{
            System.out.println("The elements do not exist");
        }
