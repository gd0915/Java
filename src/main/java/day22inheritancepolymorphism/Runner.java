...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        Mammal d = new Cat();
        System.out.println(d.name);//Mammal ==> because Mammal is a parent class and for the variable we look at the Data type of the object and then go to this class
        ...
        Cat f = new Cat();
        f.eat();//Cats eat...(Overriding from the Cat class)
        ...
        /*
            ...
            3) super() must be the first statement in the constructor body, but just "super" can be in any line

            4) "super" is for calling variables and methods from the parent class
               super() is for calling "constructors" from parent class
        ...
        /*
           ...
           1)When the child classes use the methods from the parent classes, we may need to update implementation of the methods.
            ...
            8)When you do "method overriding" return type of the "Overriding Method" can be same or the child of the return type
            ...
            9) Between the "Wrapper Classes" Java did not create "Parent-Child Relationship", therefore
               between the Wrapper Classes there is no "IS-A" relation-ship. If there is no "IS-A" relationship you cannot
               change the return types in "Method Overriding"
            ...
            if any child class updates the static method body other child classes will be effected as well,
             therefore Java does not let you override a static method
