...
public class Variables01 {
    ...
    public static void main(String[] args) {
        ...
        /*
             ...
             The minimum value of integers -2,147,483,648
             The maximum value of integers 2,147,483,647
             ...
             The minimum value of longs is -9,223,372,036,854,755,808
             The maximum value of longs is  9,223,372,036,854,755,807
             Byte variables use 64 bits in memory
        ...
        System.out.println(populationOfGermany);
          ...
          //Java accepts long values as integer as default, but if your value is greater than the maximum value of
         //  integers you will get error. To fix this error you have to put "L" or "l" to the end of the number.
        ...
        /*
        2 more Data Types
        1)boolean: for true/false (means yes/no) It is used for "true" and "false" answers.
          boolean uses just 1 bit in memory
        2)char:It is just for a "single" character
        ...
        2)"Primitive Data Types"  were created by Java, we cannot create any Primitive Data Types.
          But we can create Non-Primitive Data Types" whenever we need
        3)"Primitive Data Types" use just lower cases in their names
        But Non-Primitive Data Types" starts with upper case
        ...
        // If you use different numeric data types in any math operation,the result will be in the largest data type
        ...
        float priceOfSocks = 2.99F, priceOfShirts = 12.88F;
        short populationOfVillage1 = 8000, populationOfVillage2 = 9000, populationOfVillage3 = 10000;

        System.out.println(priceOfSocks + priceOfShirts + populationOfVillage1 + populationOfVillage2 + populationOfVillage3);
        ...
        char room = 'A';
        int i1 = 32;
        // When we use any char in any math operation Java uses the ASCII value of the char
        System.out.println( room + i1);
