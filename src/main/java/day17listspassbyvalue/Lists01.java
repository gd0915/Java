...
public class Lists01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(c);// K ==> [A, Got it, R, S]
        ...
        int i = d.indexOf("Rs");
        System.out.println(i);//2  gives us the first occurrence

        int f = d.indexOf("Xy");
        System.out.println(f);// -1 because it does not exist
        ...
        // lastIndexOF() method gives you the index of last occurrence of a specific element
        // lastIndexOF() method returns -1 for non-existing elements
        int h = d.lastIndexOf("Rs");
