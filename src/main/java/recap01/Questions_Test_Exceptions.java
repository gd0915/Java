...
public class Questions_Test_Exceptions {
    ...
    14)What is your options when you encounter a "Compile Time Exception"? --> I have two options:
    ...
    15)What is the difference between "throw" and "throws" keywords? -->i)"Throw" keyword is used to throw an Exception in anywhere inside the method body.
